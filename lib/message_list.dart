...
import 'package:flutter_firebase_demo/message_widget.dart';
...
class MessageListState extends State<MessageList> {
  ...
  void _sendMessage() {
    if (_canSendMessage()) {
      final randomNo = Random().nextInt(10).toString();
      final message = Message(randomNo,_messageController.text, DateTime.now());
